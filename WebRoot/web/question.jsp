...
<body>
	...
	<div id="header-wrapper">
		<jsp:include page="./menu.jsp"><jsp:param value="question" name="type" />
		</jsp:include>
	</div>
		...
		<div class="5grid-layout" style="margin-top: 50px">
			<div class="row">
				<div class="3u" style="width: 100%">
					<form action="${ctx}/sys/addQuestion.action" method="post">
						<input type="text" placeholder="输入问题" name="content" size="60">
						<input type="submit" value="提问" class="button orange">
					</form>
				</div>
						...
						<tbody>
							<c:forEach items="${questionList }" var="item">
								<tr>
									...
									<td>${item.addDate }</td>
									<td>
										<a href="${ctx}/com/answer.action?questionId=${item.id}" class="btn btn-green" data-toggle="navtab">查看回答</a>
									</td>
								</tr>
							</c:forEach>
						</tbody>
