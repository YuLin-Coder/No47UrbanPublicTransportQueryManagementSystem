...
<body>
	...
	<div id="header-wrapper">
		<jsp:include page="./menu.jsp"><jsp:param value="notice" name="type" />
		</jsp:include>
	</div>
		...
		<div class="5grid-layout" style="margin-top: 50px">
			<div class="row">
				<div class="3u" style="width: 100%">
					<form action="${ctx}/com/notice.action" method="post">
						<input type="text" placeholder="输入标题" name="title" value="${title}">
